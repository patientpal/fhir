...
export const RTTI_Questionnaire: t.Type<IQuestionnaire> = t.recursion(
  'IQuestionnaire',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        title: t.string,
        _title: RTTI_Element,
        derivedFrom: t.array(RTTI_canonical),
        status: createEnumType<QuestionnaireStatusKind>(
