...
import { IClaim_Detail, RTTI_Claim_Detail } from './RTTI_Claim_Detail'
...
export const RTTI_Claim_Item: t.Type<IClaim_Item> = t.recursion(
  'IClaim_Item',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        careTeamSequence: t.array(RTTI_positiveInt),
        _careTeamSequence: t.array(RTTI_Element),
        diagnosisSequence: t.array(RTTI_positiveInt),
        _diagnosisSequence: t.array(RTTI_Element),
        procedureSequence: t.array(RTTI_positiveInt),
        _procedureSequence: t.array(RTTI_Element),
        informationSequence: t.array(RTTI_positiveInt),
