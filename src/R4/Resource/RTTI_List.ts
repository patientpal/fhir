...
import { IList_Entry, RTTI_List_Entry } from './RTTI_List_Entry'
...
export const RTTI_List: t.Type<IList> = t.recursion('IList', () =>
  t.intersection([
    ...
    t.partial({
      ...
      status: createEnumType<ListStatusKind>(ListStatusKind, 'ListStatusKind'),
      _status: RTTI_Element,
      mode: createEnumType<ListModeKind>(ListModeKind, 'ListModeKind'),
      _mode: RTTI_Element,
      title: t.string,
      _title: RTTI_Element,
