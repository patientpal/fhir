...
import { ITask_Input, RTTI_Task_Input } from './RTTI_Task_Input'
import { ITask_Output, RTTI_Task_Output } from './RTTI_Task_Output'
import {
  ITask_Restriction,
...
export const RTTI_Task: t.Type<ITask> = t.recursion('ITask', () =>
  t.intersection([
    ...
    t.partial({
      ...
      instantiatesCanonical: RTTI_canonical,
