...
export const RTTI_Goal_Target: t.Type<IGoal_Target> = t.recursion(
  'IGoal_Target',
  () =>
    t.partial({
      id: t.string,
      ...
      detailString: t.string,
      _detailString: RTTI_Element,
      detailBoolean: t.boolean,
      _detailBoolean: RTTI_Element,
      detailInteger: t.number,
      _detailInteger: RTTI_Element,
      detailRatio: RTTI_Ratio,
      dueDate: t.string,
