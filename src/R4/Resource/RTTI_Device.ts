...
import { IDevice_Property, RTTI_Device_Property } from './RTTI_Device_Property'
import {
...
import { IDevice_Version, RTTI_Device_Version } from './RTTI_Device_Version'
...
export const RTTI_Device: t.Type<IDevice> = t.recursion('IDevice', () =>
  t.intersection([
    ...
    t.partial({
      ...
      status: createEnumType<DeviceStatusKind>(
        DeviceStatusKind,
        'DeviceStatusKind',
      ),
      _status: RTTI_Element,
      statusReason: t.array(RTTI_CodeableConcept),
      distinctIdentifier: t.string,
      _distinctIdentifier: RTTI_Element,
      manufacturer: t.string,
      _manufacturer: RTTI_Element,
      manufactureDate: RTTI_dateTime,
