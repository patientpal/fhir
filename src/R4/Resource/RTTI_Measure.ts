...
import { IMeasure_Group, RTTI_Measure_Group } from './RTTI_Measure_Group'
import {
...
export const RTTI_Measure: t.Type<IMeasure> = t.recursion('IMeasure', () =>
  t.intersection([
    ...
    t.partial({
      ...
      status: createEnumType<MeasureStatusKind>(
        MeasureStatusKind,
        'MeasureStatusKind',
      ),
