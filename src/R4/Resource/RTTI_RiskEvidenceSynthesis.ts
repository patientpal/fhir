...
export const RTTI_RiskEvidenceSynthesis: t.Type<
  IRiskEvidenceSynthesis
> = t.recursion('IRiskEvidenceSynthesis', () =>
  t.intersection([
    t.type({
    ...
    t.partial({
      ...
      title: t.string,
      _title: RTTI_Element,
      status: createEnumType<RiskEvidenceSynthesisStatusKind>(
      ...
      sampleSize: RTTI_RiskEvidenceSynthesis_SampleSize,
      riskEstimate: RTTI_RiskEvidenceSynthesis_RiskEstimate,
      certainty: t.array(RTTI_RiskEvidenceSynthesis_Certainty),
    }),
  ]),
)
