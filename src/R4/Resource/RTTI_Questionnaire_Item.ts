...
export const RTTI_Questionnaire_Item: t.Type<IQuestionnaire_Item> = t.recursion(
  'IQuestionnaire_Item',
  () =>
    t.partial({
      id: t.string,
      ...
      text: t.string,
      _text: RTTI_Element,
      type: createEnumType<Questionnaire_ItemTypeKind>(
        Questionnaire_ItemTypeKind,
        'Questionnaire_ItemTypeKind',
      ),
      _type: RTTI_Element,
      enableWhen: t.array(RTTI_Questionnaire_EnableWhen),
      enableBehavior: createEnumType<Questionnaire_ItemEnableBehaviorKind>(
