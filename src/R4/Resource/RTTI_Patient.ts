...
import { IPatient_Contact, RTTI_Patient_Contact } from './RTTI_Patient_Contact'
import { IPatient_Link, RTTI_Patient_Link } from './RTTI_Patient_Link'
...
export const RTTI_Patient: t.Type<IPatient> = t.recursion('IPatient', () =>
  t.intersection([
    ...
    t.partial({
      ...
      gender: createEnumType<PatientGenderKind>(
        PatientGenderKind,
        'PatientGenderKind',
      ),
