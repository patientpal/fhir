...
export const RTTI_ResearchElementDefinition_Characteristic: t.Type<
...
> = t.recursion('IResearchElementDefinition_Characteristic', () =>
  t.partial({
    ...
    studyEffectiveGroupMeasure: createEnumType<
    ...
    participantEffectiveGroupMeasure: createEnumType<
