...
export const RTTI_DeviceMetric: t.Type<IDeviceMetric> = t.recursion(
  'IDeviceMetric',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        operationalStatus: createEnumType<DeviceMetricOperationalStatusKind>(
          DeviceMetricOperationalStatusKind,
          'DeviceMetricOperationalStatusKind',
        ),
        _operationalStatus: RTTI_Element,
        color: createEnumType<DeviceMetricColorKind>(
          DeviceMetricColorKind,
          'DeviceMetricColorKind',
        ),
        _color: RTTI_Element,
        category: createEnumType<DeviceMetricCategoryKind>(
