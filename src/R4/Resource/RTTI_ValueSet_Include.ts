...
import { IValueSet_Filter, RTTI_ValueSet_Filter } from './RTTI_ValueSet_Filter'
...
export const RTTI_ValueSet_Include: t.Type<IValueSet_Include> = t.recursion(
  'IValueSet_Include',
  () =>
    t.partial({
      id: t.string,
      ...
      valueSet: t.array(RTTI_canonical),
    }),
)
