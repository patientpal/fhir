...
export const RTTI_MolecularSequence: t.Type<IMolecularSequence> = t.recursion(
  'IMolecularSequence',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        type: createEnumType<MolecularSequenceTypeKind>(
          MolecularSequenceTypeKind,
          'MolecularSequenceTypeKind',
        ),
        _type: RTTI_Element,
        coordinateSystem: RTTI_integer,
