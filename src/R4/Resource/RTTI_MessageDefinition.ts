...
export const RTTI_MessageDefinition: t.Type<IMessageDefinition> = t.recursion(
  'IMessageDefinition',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        status: createEnumType<MessageDefinitionStatusKind>(
        ...
        base: RTTI_canonical,
        parent: t.array(RTTI_canonical),
        eventCoding: RTTI_Coding,
        eventUri: t.string,
        _eventUri: RTTI_Element,
        category: createEnumType<MessageDefinitionCategoryKind>(
          MessageDefinitionCategoryKind,
          'MessageDefinitionCategoryKind',
        ),
        _category: RTTI_Element,
        focus: t.array(RTTI_MessageDefinition_Focus),
        responseRequired: createEnumType<MessageDefinitionResponseRequiredKind>(
