...
export const RTTI_CatalogEntry: t.Type<ICatalogEntry> = t.recursion(
  'ICatalogEntry',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        status: createEnumType<CatalogEntryStatusKind>(
          CatalogEntryStatusKind,
          'CatalogEntryStatusKind',
        ),
        _status: RTTI_Element,
        validityPeriod: RTTI_Period,
        validTo: RTTI_dateTime,
        _validTo: RTTI_Element,
        lastUpdated: RTTI_dateTime,
