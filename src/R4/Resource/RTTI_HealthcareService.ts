...
export const RTTI_HealthcareService: t.Type<IHealthcareService> = t.recursion(
  'IHealthcareService',
  () =>
    t.intersection([
      t.type({
      ...
      t.partial({
        ...
        eligibility: t.array(RTTI_HealthcareService_Eligibility),
        program: t.array(RTTI_CodeableConcept),
