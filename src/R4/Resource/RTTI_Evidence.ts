...
export const RTTI_Evidence: t.Type<IEvidence> = t.recursion('IEvidence', () =>
  t.intersection([
    t.type({
      resourceType: t.literal('Evidence'),
      exposureBackground: RTTI_Reference,
    }),
    t.partial({
      id: RTTI_id,
      meta: RTTI_Meta,
      ...
      status: createEnumType<EvidenceStatusKind>(
        EvidenceStatusKind,
        'EvidenceStatusKind',
      ),
      ...
      exposureVariant: t.array(RTTI_Reference),
      outcome: t.array(RTTI_Reference),
    }),
  ]),
)
