...
export const RTTI_ResearchElementDefinition: t.Type<
  IResearchElementDefinition
> = t.recursion('IResearchElementDefinition', () =>
  t.intersection([
    t.type({
      resourceType: t.literal('ResearchElementDefinition'),
      characteristic: t.array(RTTI_ResearchElementDefinition_Characteristic),
    }),
    t.partial({
      id: RTTI_id,
      meta: RTTI_Meta,
      ...
      status: createEnumType<ResearchElementDefinitionStatusKind>(
      ...
      type: createEnumType<ResearchElementDefinitionTypeKind>(
        ResearchElementDefinitionTypeKind,
        'ResearchElementDefinitionTypeKind',
      ),
      _type: RTTI_Element,
      variableType: createEnumType<ResearchElementDefinitionVariableTypeKind>(
