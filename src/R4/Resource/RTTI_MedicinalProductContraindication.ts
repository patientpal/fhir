...
import { IPopulation, RTTI_Population } from './RTTI_Population'
...
export const RTTI_MedicinalProductContraindication: t.Type<
  IMedicinalProductContraindication
> = t.recursion('IMedicinalProductContraindication', () =>
  t.intersection([
    t.type({
